...
def embedding_model(arr, vocab_size=10_000, seq_len=256, **_):
    ...
    # the reduction happens over seq_dim
    # in pytorch, it actually requires to be transposed
    o2 = token_embedding_map(x)
...
def logistic_loss(model, params, batch):
    ...
    # have to always supply the RNG field -- this is nice for reproducible results guarantee
    logits = model.apply(params, None, inputs)
