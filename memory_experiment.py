...
def oom_fn(bs, cmd, print_error=False):
    ...
    # oom = proc.returncode != 0  # 'Out of memory' in proc.stdout
    oom = 'out of memory' in proc.stdout.lower() or 'oom' in proc.stdout.lower(
    ) or 'resourceexhausted' in proc.stdout.lower()
